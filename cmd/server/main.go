...
func main() {
	...
	flag.BoolVar(&miromindLogin, "miromind-login", false, "Login to MiroMind using Session Token")
	...
	} else if miromindLogin {
		cmd.DoMiroMindLogin(cfg, options)
	} else {
